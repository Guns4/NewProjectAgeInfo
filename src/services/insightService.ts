...
import { ZodiacResult } from '@/lib/identity-engine';
...
const NEPTU_PHILOSOPHY: Record<number, { id: string; en: string }> = {
    7: { id: "Melambangkan kerendahan hati dan ketenangan batin.", en: "Symbolizes humility and inner peace." },
    8: { id: "Memiliki pendirian yang kuat dan tahan uji.", en: "Possesses strong determination and resilience." },
    9: { id: "Penuh semangat dan memiliki potensi kepemimpinan.", en: "Full of spirit and leadership potential." },
    10: { id: "Cerdas, diplomatis, dan mudah bergaul.", en: "Intelligent, diplomatic, and sociable." },
    11: { id: "Berjiwa sosial tinggi dan penuh kasih sayang.", en: "High social spirit and compassion." },
    12: { id: "Mampu menjadi penengah yang bijaksana.", en: "Capable of being a wise mediator." },
    13: { id: "Melambangkan watak yang kuat namun tenang.", en: "Symbolizes a strong yet calm character." },
    14: { id: "Memiliki intuisi tajam dan daya tarik alami.", en: "Sharp intuition and natural charisma." },
    15: { id: "Suka petualangan dan memiliki visi yang luas.", en: "Loves adventure and has a broad vision." },
    16: { id: "Memiliki kedalaman spiritual dan kreativitas.", en: "Deep spiritual depth and creativity." },
    17: { id: "Berwibawa dan disegani banyak orang.", en: "Authoritative and respected by many." },
    18: { id: "Melambangkan kesempurnaan dan keberuntungan.", en: "Symbolizes perfection and good fortune." },
};
 ...
 */
export function generateInsights(neptu: number, element: ZodiacResult['element'], locale: string): InsightResult {
